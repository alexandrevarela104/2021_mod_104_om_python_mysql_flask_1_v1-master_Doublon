...
"""
    ...
    Test : ex : http://127.0.0.1:5005/factures_afficher
        ...
        try:
            ...
            with MaBaseDeDonnee().connexion_bd.cursor() as mc_afficher:
                if order_by == "ASC" and id_genre_sel == 0:
                    strsql_factures_afficher = """SELECT id_user, nom_user, email, password FROM t_user ORDER BY id_user ASC"""
                    ...
                    strsql_factures_afficher = """SELECT id_user, nom_user FROM t_user  WHERE id_user = %(value_id_user_selected)s"""

                    mc_afficher.execute(strsql_factures_afficher, valeur_id_genre_selected_dictionnaire)
                else:
                    strsql_factures_afficher = """SELECT id_user, nom_user, email, password FROM t_user ORDER BY id_user DESC"""
