...
try:
    ...
    strsql_factures_afficher = """SELECT id_facture, numero_facture, somme, delai FROM t_facture ORDER BY id_user ASC"""
    curseur_mabd.execute(strsql_factures_afficher)
    data_factures = curseur_mabd.fetchall()

    print("data_factures ", data_genres, " Type : ", type(data_factures))
